...
class CmccZsyyt extends App {
    ...
    ok(data) {
        return data && data.result && (data.result.code == 0 || data.result.code == 2);
    }
    run(params) {
        return this.r.postForm("http://218.205.252.24:18081/scmccCampaign/signCalendar/sign.do", params);
    }
    is_online(params) {
